...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_ROOT}/IGListKit/IGListKit.framework"
  install_dsym "${PODS_ROOT}/IGListKit/IGListKit.framework.dSYM"
  install_framework "${PODS_ROOT}/Realm/Realm.framework"
  install_dsym "${PODS_ROOT}/Realm/Realm.framework.dSYM"
  install_framework "${PODS_ROOT}/RealmSwift/RealmSwift.framework"
  install_dsym "${PODS_ROOT}/RealmSwift/RealmSwift.framework.dSYM"
  install_framework "${PODS_ROOT}/RxAtomic/RxAtomic.framework"
  install_dsym "${PODS_ROOT}/RxAtomic/RxAtomic.framework.dSYM"
  install_framework "${PODS_ROOT}/RxCocoa/RxCocoa.framework"
  install_dsym "${PODS_ROOT}/RxCocoa/RxCocoa.framework.dSYM"
  install_framework "${PODS_ROOT}/RxRealm/RxRealm.framework"
  install_dsym "${PODS_ROOT}/RxRealm/RxRealm.framework.dSYM"
  install_framework "${PODS_ROOT}/RxSwift/RxSwift.framework"
  install_dsym "${PODS_ROOT}/RxSwift/RxSwift.framework.dSYM"
fi
