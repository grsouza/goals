...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/RxBlocking/RxBlocking.framework"
  install_dsym "${PODS_ROOT}/RxBlocking/RxBlocking.framework.dSYM"
  install_framework "${PODS_ROOT}/RxTest/RxTest.framework"
  install_dsym "${PODS_ROOT}/RxTest/RxTest.framework.dSYM"
fi
